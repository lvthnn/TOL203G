...
\subsubsection*{Hluti (b)}
    \begin{enumerate}[(i)]
       ...
       \item Látum $n$ og $m$ tákna fjöldann af gildunum $A$ og $B$ í fylkinu, í þeirri röð. Ef $n \gg m$ þá erum við ca. að fást við (ii) í (a)-lið.
       Ef $n \approx m$ og við gerum ráð fyrir að röðin í fylkinu sé slembin getum við skilgreint slembistærðina $X$ sem meðalfjölda samanburða sem 
       innsetningarröðun framkvæmir úr tilteknu staki \texttt{a[i]} áður en það stöðvar. $X$ er tvíkostastærð með $p = 0.5$, þ.e. $X \sim \text{Bin}(n + m, p)$
       en $\text E[X] = (n + m)p$ lýsir meðalfjölda samanburða sem þarf.
    \end{enumerate}

\newpage

\section*{Verkefni 4}
Við getum skilgreint röðunarreikniritið \texttt{Slembiröðun}, sem virkar þannig að á meðan fylkið
